      ...
      <div className="grid gap-4 lg:grid-cols-3">
        ...
        >
          <div className="aspect-[16/9] w-full overflow-hidden">
            <Cover src={coverImage(lead.featured_image, lead.category?.slug ?? "national", lead.title)} alt={lead.title} />
          </div>
          ...
          {rest.slice(0, 3).map((a) => (
            ...
            >
              <div className="relative h-20 w-32 shrink-0 overflow-hidden rounded">
                <Cover src={coverImage(a.featured_image, a.category?.slug ?? "national", a.title)} alt={a.title} />
                <PlayBadge />
              </div>
