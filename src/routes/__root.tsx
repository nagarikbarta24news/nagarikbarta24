...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "নাগরিক বার্তা ২৪ (Nagarik Barta 24) — বাংলাদেশের সর্বশেষ জাতীয়, রাজনীতি, অর্থনীতি, খেলা ও প্রযুক্তির খবর ও বিশ্লেষণ।" },
      ...
      { property: "og:title", content: "নাগরিক বার্তা ২৪ | Nagarik Barta 24 — সর্বশেষ বাংলা সংবাদ" },
      { property: "og:description", content: "নাগরিক বার্তা ২৪ (Nagarik Barta 24) — বাংলাদেশের সর্বশেষ জাতীয়, রাজনীতি, অর্থনীতি, খেলা ও প্রযুক্তির খবর।" },
