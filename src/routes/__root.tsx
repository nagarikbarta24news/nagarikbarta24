...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "নাগরিক বার্তা ২৪ | বাংলাদেশ পেজ" },
      ...
      { property: "og:description", content: "সর্বশেষ জাতীয়, রাজনীতি, অর্থনীতি, খেলা ও প্রযুক্তির খবর — নাগরিক বার্তা ২৪।" },
      { property: "og:image", content: "/og-image.jpg" },
      { property: "og:image:width", content: "1200" },
      { property: "og:image:height", content: "630" },
      { property: "og:image:alt", content: "নাগরিক বার্তা ২৪ লোগো" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "নাগরিক বার্তা ২৪ | বাংলাদেশ পেজ" },
      { name: "twitter:description", content: "সর্বশেষ জাতীয়, রাজনীতি, অর্থনীতি, খেলা ও প্রযুক্তির খবর — নাগরিক বার্তা ২৪।" },
