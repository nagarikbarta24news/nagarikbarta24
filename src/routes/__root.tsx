...
import { checkSupabaseConnectivity, clearCachedConnectivity, getCachedConnectivityOk, describeKeyKind, type SupabaseConnectivityResult } from "@/lib/supabase-connectivity";
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  ...
  head: () => ({
    meta: [
      ...
      { name: "google-site-verification", content: "na-FVIKBHCzlWsTr6ITwsqlcvwuyB6NZwthqj69Y36c" },
